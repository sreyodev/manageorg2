...
<%
	...
	int orgId;
	try {
		JSONArray jsonArray = new Utility().convertRsToJson(new managedorg.organisation.web.Utility().fetchOrgDetails(identifier));
		if(jsonArray.length() == 1) {
			...
			JSONArray jsonArray2 = new Utility().convertRsToJson(new managedorg.organisation.web.Utility().fetchOrgTheme(orgId));
