...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Sign Up | ManagedOrg</title>
		<meta name="description" content="Managedorg Registration" />
				...
				<div class="login-aside d-flex flex-column flex-row-auto">
					...
					<div class="d-flex flex-column-auto flex-column pt-15 px-30">
						...
						<a href="#" class="login-logo py-6">
							<img src="assets/media/logos/logo.png" class="max-h-70px" alt="LOGO" />
						</a>
						<!--end::Aside header-->
						<!--begin: Wizard Nav-->
					...
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img-wizard d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center pt-2 pt-lg-5" style="background-position-y: calc(100% + 3rem); background-image: url(assets/media/svg/signup.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
				<div class="login-content flex-column-fluid d-flex flex-column p-10">
					...
					<div class="text-right d-flex justify-content-center">
						<div class="top-signup text-right d-flex justify-content-end pt-5 pb-lg-0 pb-10">
							...
							<a onClick="loadHelp();" class="font-weight-bolder text-primary font-size-h4 ml-2" id="kt_login_signup">Get Help</a>
						</div>
					</div>
					<!--end::Top-->
					<!--begin::Wrapper-->
							...
							<form class="form" novalidate="novalidate" id="kt_login_signup_form">
								...
								<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
									...
									<div class="pb-10 pb-lg-15">
										...
										<a href="login.jsp" class="text-primary font-weight-bolder">Sign In</a></div>
									</div>
									<!--begin::Title-->
									<!--begin::Form Group-->
